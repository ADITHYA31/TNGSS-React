...
export default function Footer() {
    return(
        ...
        <div className=" flex flex-col bg-[#18BFDB]  h-[60vh] rounded-t-[48px] md:rounded-t-[60px] overflow-hidden">
        <div className=" inline-flex whitespace-nowrap w-full  animate-marquee text-black font-medium text-4xl md:text-7xl space-x-16 py-3 pt-5 ">
        ...
        <div className=" z-10 bg-black h-full rounded-t-[48px] md:rounded-t-[70px]  overflow-hidden flex flex-col ">
            <div className=" safe-cont relative flex items-center justify-center h-full w-full group ">
                ...
                <p className=" text-center text-6xl md:text-9xl font-medium tracking-widest  group-hover:-rotate-6 transition-all duration-300">
                    DISRUPT TO RAISE
                </p>
                </div>
            </div>

            <div className=" safe-cont flex max-md:flex-col  w-full py-2  md:justify-between md:items-center">
