...
export default function NavBar() {
  ...
  return (
    <>
      {/* Navbar */}
      <motion.div
        className={` navbar flex fixed top-0 left-0 z-50 p-3 text-white blur-sm  w-full justify-between items-center py-5 border-b ${isScrolled ? 'bg-black':'bg-transparent'} bg-opacity-80 border-gray-600`}
